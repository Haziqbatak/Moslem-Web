const city = 1609
const date = new Date();
const dd = String(date.getDate()).padStart(2, '0');//padStart untuk didepan angka ada angka nol, jika satuandigitnya kurang dari batasan yg kita tentukan
...
.then(function(response){
    if(!response.ok) {
        throw new Error(`API tidak dapat diambil, ada yang salah`)
    }
